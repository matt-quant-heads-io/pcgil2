...
class PcgilEnv(gym.Env):
    ...
    def __init__(self, prob="binary", rep="narrow"):
        ...
        self._goal_map_oh = str_map_to_onehot(self._prob._goal_map)
        ...
        self._rep_stats = self._prob.get_stats(self._init_map_oh, self._goal_map_oh)
    ...
    def step(self, action):
        ...
        if change > 0:
            ...
            # print(f"self._rep._map is {self._rep._map}")
            self._rep_stats = self._prob.get_stats(get_string_map(int_map_from_onehot(self._rep._map), self._prob.get_tile_types()), self._goal_map)
