...
class Representation:
    ...
    def start_nonrandom_map(self, start_map):
        self._old_map = start_map
        self._map = start_map
    ...
    def reset(self, start_map):
        ...
        #     self._old_map = init_map.copy()
        self._map = start_map.copy()
        self._old_map = start_map.copy()
    ...
    def adjust_param(self, **kwargs):
        self._random_start = False # kwargs.get('random_start', self._random_start)
