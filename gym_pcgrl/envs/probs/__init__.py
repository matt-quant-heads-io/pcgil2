...
from gym_pcgrl.envs.probs.zelda_hamm_prob import ZeldaProblemHamm
from gym_pcgrl.envs.probs.zelda_orderless_prob import ZeldaProblemOrderless
...
PROBLEMS = {
    ...
    "zelda": ZeldaProblem,
    "zeldahamm": ZeldaProblemHamm,
    "zeldaorderless": ZeldaProblemOrderless,
    "smb": SMBProblem
}
